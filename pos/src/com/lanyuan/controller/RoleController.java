...
public class RoleController {
	...
	public String addUI(Model model){
		...
		return Common.ROOT_PATH+"/background/role/add";
	} 
	/**
	 * 权限树
	 * @return
	...
	public String query(Model model,Roles role,String pageNow){
		...
		return Common.ROOT_PATH+"/background/role/list";
	}
	...
	public String getById(Model model,String roleId,int typeKey){
		...
		if(typeKey == 1){
			return Common.ROOT_PATH+"/background/role/edit";
		}else{
			return Common.ROOT_PATH+"/background/role/show";
		}
	}
...
//		return Common.ROOT_PATH+"/background/role/permissioUser";
//	}
}
