...
public class BackgroundController
{
	...
	public String login(Model model,HttpServletRequest request)
	{
		...
		return Common.ROOT_PATH+"/background/framework/login";
	}
	...
	public String loginCheck(String username,String password,HttpServletRequest request){
		try {
			...
			String pass = Md5Tool.getMd5(password);
			if (users == null || !users.getUserPassword().equals(pass)) {
			...
			request.getSession().setAttribute("userSessionId", users.getUserId());
			// 记录登录信息
	...
	{
		return Common.ROOT_PATH+"/background/framework/main";
	}
	...
	public String left(Model model,HttpServletRequest request)
	{
		...
		return Common.ROOT_PATH+"/background/framework/left";
	}
	
	@RequestMapping ("tab")
	public String tab(Model model)
	{
		return Common.ROOT_PATH+"/background/framework/tab/tab";
	}
	
	@RequestMapping ("center")
	public String center(Model model)
	{
		return Common.ROOT_PATH+"/background/framework/center";
	}
