...
public class ResourcesController {
	...
	public String addUI(Model model){
		...
		return Common.ROOT_PATH+"/background/resources/add";
	} 
	...
	public String query(Model model,Resources resources,String pageNow){
		...
		return Common.ROOT_PATH+"/background/resources/list";
	}
	...
	public String getById(Model model,String resourcesId,int typeKey){
		...
		model.addAttribute("resources", resources);
		List<Resources> resLists = resourcesService.queryAll(new Resources());
		model.addAttribute("resLists", resLists);
		if(typeKey == 1){
			return Common.ROOT_PATH+"/background/resources/edit";
		}else{
			return Common.ROOT_PATH+"/background/resources/show";
		}
	}
	...
	public String permissioUser(Model model,String userId){
		...
		List<Resources> allRes = resourcesService.queryAll(new Resources());
		...
		return Common.ROOT_PATH+"/background/resources/permissioUser";
	}
	/**
	 * 某个角色拥有的权限
	 * @return
