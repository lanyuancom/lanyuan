...
<br/>
<br/>  
<form action="${pageContext.servletContext.contextPath }/background/productBrand/add.html" method="post">
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
							 <input id="productBrandName" style="height: 20px;width: 200px" name="productBrandName"/>
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
							...
							<font color="red">	如果是顶级父类，则不需要选择，，，</font>
						</div>
					</td>
				</tr>
				<tr>
