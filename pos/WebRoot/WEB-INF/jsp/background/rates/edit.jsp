...
<br/>
<br/>  
<form action="${pageContext.servletContext.contextPath }/background/rates/update.html" method="post">
		...
		<table class="ttab" height="100" width="70%" border="0" cellpadding="0" cellspacing="1"
			...
			<tr>	
					...
					<td >
						...
						<input style="height: 20px;width: 200px" name="channelname" value="${rates.channelname}"/>
						</div>
					</td>
				</tr>
			<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" value="${rates.mark}" name="mark"/>
						</div>
					</td>
				</tr>
				<tr>	
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" value="${rates.settlementCaps}" name="settlementCaps"/>元/次
						</div>
					</td>
				</tr>
				<tr>
