...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/bill/query.html" method="post">
<table width="100%">
  <tr>
              ...
              <tr>
                ...
                <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><a href="${pageContext.servletContext.contextPath }/bill/addUI">新增</a></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
  	...
  	<div class="search_k" align="left">
		<fieldset class="search">
			...
			<div class="search_content">
				交易账号：<input type="text" name="accountBalance" value="${param.accountBalance}" style="height: 20px"/>　　
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="10%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">支付类型</span></td>
            <td width="10%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">交易金额</span></td>
            <td width="8%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">交易费用</td>
            <td width="5%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">结算费</td>
            <td width="10%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">交易账号</td>
            <td width="20%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">交易时间</td>
            <td width="23%" height="22" background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">操作</td>
          </tr>
          
          <c:forEach var="bill" items="${pageView.records}">
          <tr>
            <td height="20" >
              <input type="checkbox" name="check" value="${bill.id}" />
            </td>
            
            <td height="20" ><span class="STYLE1">${bill.tradeType}</span></td>
            <td height="20" ><span class="STYLE1">${bill.tradeMoney}</span></td>
            <td height="20" ><span class="STYLE1">${bill.transaction}</span></td>
            <td height="20" ><span class="STYLE1">${bill.transaction}</span></td>
            <td height="20" ><span class="STYLE1">${bill.conveyancing}</span></td>
            <td height="20" ><span class="STYLE1">${bill.accountBalance}</span></td>
            <td height="20" ><span class="STYLE1"><fmt:formatDate value="${bill.tradeTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span></td>
            <td height="20" ><span class="STYLE4">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="${pageContext.servletContext.contextPath }/background/bill/getById.html?billId=${bill.id}&type=0">
            	显示详细信息</a>
            	&nbsp;&nbsp;
            <img src="${pageContext.servletContext.contextPath }/images/edt.gif" width="16" height="16" />
            <a href="${pageContext.servletContext.contextPath }/background/bill/getById.html?billId=${bill.id}&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/bill/deleteById.html?billId=${bill.id}')">
            	删除</a>
            	</span></td>
          </tr>
          </c:forEach>
