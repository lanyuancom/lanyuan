...
<body>
	<form id="fenye" name="fenye"
		action="${pageContext.servletContext.contextPath }/background/orderlist/query.html"
		method="post">
		<table width="100%">
			<tr>
				<td height="30"
			...
			<tr>
				<td><table class="listtable" width="100%">
						<tr>
							...
							<td><table class="ttab" width="100%" cellspacing="1"
										...
										<td height="22"
											...
											<div align="center">
												<input id="chose" type="checkbox" name="checkbox"
													value="checkbox" onclick="selectAllCheckBox()" />
											</div>
										</td>
										<td height="22"
											background="${pageContext.servletContext.contextPath }/images/bg.gif"
										...
										<tr>
											...
											<td height="20" bgcolor="#FFFFFF">
												<div align="center" class="STYLE1">
													<div align="center">${key.orderId}</div>
												</div>
											</td>
											<td height="20" bgcolor="#FFFFFF">
												<div align="center">
											...
											<td bgcolor="#FFFFFF">
												<div align="center">
													<span class="STYLE1">${key.productNum}</span>
												</div>
											</td>
											<td bgcolor="#FFFFFF">
												<div align="center">
													<span class="STYLE1">${key.productSumPrice}</span>
												</div>
											</td>
											<td bgcolor="#FFFFFF">
												<div align="center">
													<span class="STYLE1">${key.userAddress}</span>
												</div>
											</td>
											<td bgcolor="#FFFFFF">
												<div align="center">
													<span class="STYLE1">${key.userPhone}</span>
												</div>
											</td>
											<td height="20" bgcolor="#FFFFFF"><span class="STYLE4"><img
													src="${pageContext.servletContext.contextPath }/images/edt.gif"
													width="16" height="16" /> <a
													href="${pageContext.servletContext.contextPath }/background/orderlist/getById.html?id=${key.orderId}&type=1">
														编辑 </a> &nbsp; &nbsp; <img
													src="${pageContext.servletContext.contextPath }/images/del.gif"
													width="16" height="16" /> <a href="javascript:void(0);"
													onclick="deleteId('${pageContext.servletContext.contextPath }/background/orderlist/deleteById.html?id=${key.orderId}')">
														删除</a> </span>
											</td>
										</tr>
									</c:forEach>
