...
<input type="hidden" name="userId" value="${user.userId}">
		<table class="ttab" height="100" width="85%" border="0" cellpadding="0" cellspacing="1" align="center">
				...
				<tr>
					...
					<td>
						<div align="left" class="STYLE1" style="padding-left:10px;">
							<input type="radio" name="userSex" value="男" <c:if test="${userSex eq '男'}">checked="checked" </c:if>>
							男
							<input type="radio" name="userSex" value="女" <c:if test="${userSex eq '女'}">checked="checked" </c:if>>
							女
						</div></td>
					<td height="30" width="10%">
