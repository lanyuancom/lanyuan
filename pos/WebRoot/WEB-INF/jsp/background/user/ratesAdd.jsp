...
<br/>
<br/>  
<form action="${pageContext.servletContext.contextPath }/background/rates/add.html" method="post">
		<table class="ttab" height="100" width="70%" border="0" cellpadding="0" cellspacing="1"
			...
			<tr>
				<td height="30"
					 colspan="2">
					<div align="center">
					<font color="blue" size="6" ><b>客户费率</b></font>
					</div>
				</td>
			</tr>
			<tr>	
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="tradingRates"/>*如千分之三,填写：0.003
						</div>
					</td>
				</tr>
				<tr>	
