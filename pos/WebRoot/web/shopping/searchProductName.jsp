									...
									<td>
										...
										function pageNow(pageNow){
											...
											if(pageNow < 1){
												...
												{
													document.fenye.action="searchProductName.html?productName=${productName}&pageNow="+pageNow;
											...
											<c:forEach items="${pageView.records }" var="k">
													...
													<DL class=w260>
														...
														<DT>
														 ...
														 <div align="center">
															<A href="shopInfo.html?productId=${k.productId}" style="text-decoration: none;font-size: 14px;">
															${k.productName }
															</a>
														</div>	
															<BR>
															...
															<BR>
															<SPAN class=hy_cont> 优惠价：￥<font color=#FF0000>${k.price-30}</font>
															</SPAN>
															<br>
															会员价：￥
